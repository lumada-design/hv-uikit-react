...
const ListView = ({ classes }) => {
  ...
  return (
    <HvContainer>
      ...
      <HvGrid container className={classes.kpisListContainer}>
      ...
      <HvControls
        ...
        defaultView="card"
        callbacks={instance}
        className={classes.kpisListControls}
      >
        <HvLeftControl
          placeholder="Search"
          searchProps={{
      ...
      <HvBulkActions
        className={classes.kpisListBulkActions}
        {...bulkActionProps}
      ...
      <List className={classes.kpisListPagination} instance={instance} isLoading={isLoading} />
