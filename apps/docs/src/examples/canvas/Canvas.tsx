...
const Page = () => {
  ...
  return (
    <div className="relative h-780px w-full flex">
      <HvCanvasProvider>
        <HvFlow
        ...
        >
          <HvFlowEmpty
            ...
            icon={null}
          />
          <HvFlowBackground style={{ zIndex: theme.zIndices.popover }} />
          <HvFlowControls />
        </HvFlow>
        <HvCanvasToolbar
          className="top-[calc(var(--uikit-header-height)+var(--uikit-header-secondLevelHeight)+var(--uikit-space-md))]`"
