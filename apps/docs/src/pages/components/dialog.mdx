  ...
  return (
    <>
      ...
      >
        ...
        <HvDialogContent style={{ overflow: "visible" }} indentContent>
          <SizeSelector
            maxWidth={maxWidth}
            fullWidth={fullWidth}
...
const SemanticDialog = ({ open, variant, onClose} ) => (
  <HvDialog open={open} variant={variant}>
...
export default function Demo() {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <HvTypography variant="title4">For data:</HvTypography>
