...
import { gridClasses, HvGrid } from "@hitachivantara/uikit-react-core";

import { Header } from "@docs/components/Header";
import { getComponentData } from "@docs/utils/component";

export const getStaticProps = async ({ params }) => {
  const meta = await getComponentData("Grid", "core", gridClasses);
...
<Callout type="info">
  Please refer to the [Layout documentation](/documentation/layout) for more
  information on building layouts with UI Kit.
</Callout>
