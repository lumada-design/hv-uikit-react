...
If you encounter a bug, please open a [bug report](https://github.com/pentaho/hv-uikit-react/issues/new?template=1.bug_report.yml). Include as much detail as possible to help us reproduce the issue. Even better — feel free to submit a pull request with a fix.

### Feature Requests ✨

To suggest a new feature or enhancement, open a [feature request](https://github.com/pentaho/hv-uikit-react/issues/new?template=2.feature.yml). Feature requests may include new components or improvements to existing ones.
