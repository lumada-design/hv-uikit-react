...
- `colorMode`: The color mode of the theme. Defaults to the default color mode of the theme. UI Kit base themes support "light" and "dark" color modes (defaulting to "light"). Custom themes define their own color modes.
