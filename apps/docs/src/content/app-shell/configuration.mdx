...
Each service definition can optionally include a `ranking` property to determine the order of precedence when multiple implementations are available. Higher ranking values indicate higher precedence.
