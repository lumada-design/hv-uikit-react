...
## Scheduling
We operate in a <b>two week sprint</b> schedule, and our goal is to do a release each sprint with the work developed. Although, we will execute a build every day, publishing what is on our repo.
