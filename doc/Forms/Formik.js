...
import { HvInput, HvButton, HvCheckBoxGroup, HvCheckBox, HvDropdown } from "@hitachivantara/uikit-react-core";
...
const onSubmit = (data) => alert("Formik: " + JSON.stringify(data));
