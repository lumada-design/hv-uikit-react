...
Check <LinkTo kind="Theme/Provider" story="Main" className="sbdocs sbdocs-a">the Provider's API documentation</LinkTo> for further details.
...
3. For a fully functioning setup, you'll also need to setup a <LinkTo kind="Theme/CSS Baseline" story="Page" className="sbdocs sbdocs-a">CSS Baseline</LinkTo>
   and ensure <LinkTo kind="Theme/Typography" story="Description" className="sbdocs sbdocs-a">the loading of the Open Sans font</LinkTo>.
