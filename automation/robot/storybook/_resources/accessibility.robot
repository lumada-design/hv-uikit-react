...
verify element accessibility as standard
    ...
    ...    
    ${script}         Set Variable        pa11y --runner htmlcs --runner axe --debug --reporter json --standard ${standard} ${optional} ${url}
    ${result}=        Run Process         ${script}       shell=True    timeout=180s    alias=${url}${optional}${standard}
