...
verify banner accessibility as standard
    ...
    verify element accessibility as standard   ${STORYBOOK_URL}/iframe.html?id=corebanner--${sample}    ${standard}    ${optional} ${ignore_option}

*** Test Cases ***                             #sample    #options
storybook sample banner6 against standard      banner6    --ignore WCAG2AA.Principle4.Guideline4_1.4_1_1.F77 --ignore Section508.D.HeadingOrder
