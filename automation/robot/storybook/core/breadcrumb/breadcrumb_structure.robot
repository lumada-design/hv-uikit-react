...
breadcrumb tooltip 2 paths visible of 8
    ...
    Wait Until Element Is Visible    css:#breadcrumb    10s
    Element Text Should Be           css:#breadcrumb    Label 1\nLabel 8
    Click Element                    css:#breadcrumb button
...
breadcrumb passing url with all paths visible
    ...
    Wait Until Element Is Visible    css:#breadcrumb    10s
    Element Text Should Be           css:#breadcrumb    Sites\nDesign System\nPattern Library\nHome
