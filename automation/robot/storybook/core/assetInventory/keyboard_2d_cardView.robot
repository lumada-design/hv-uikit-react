...
keep focus when pressed right on rightmost cell in the row    ${card3}    ARROW_RIGHT    ${card3}
keep focus when pressed left on leftmost cell in the row      ${card4}    ARROW_LEFT     ${card4}
keep focus when pressed right on last card                    ${card6}    ARROW_RIGHT    ${card6}
keep focus when pressed left on first card                    ${card1}    ARROW_LEFT     ${card1}
keep focus when pressed up on first card                      ${card1}    ARROW_UP       ${card1}
keep focus card when pressed down on last card                ${card6}    ARROW_DOWN     ${card6}
