...
focus first card when pressed arrow right on last card    ${card6}    ARROW_RIGHT    ${card1}
focus previous card when pressed arrow left               ${card2}    ARROW_LEFT     ${card1}
focus last card when pressed arrow left on first card     ${card1}    ARROW_LEFT     ${card6}
focus vertical ascending card when pressed arrow up       ${card6}    ARROW_UP       ${card3}
focus last card when pressed arrow up on first card       ${card1}    ARROW_UP       ${card6}
focus vertical descending card when pressed arrow down    ${card1}    ARROW_DOWN     ${card4}
focus first card when pressed arrow down on last card     ${card6}    ARROW_DOWN     ${card1}
