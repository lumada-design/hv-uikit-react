...
focus next row when pressed arrow right                 ${row1}    ARROW_RIGHT    ${row2}
    [Tags]    TTT
focus first row when pressed arrow right on last row    ${row6}    ARROW_RIGHT    ${row1}
focus previous row when pressed arrow left              ${row2}    ARROW_LEFT     ${row1}
focus last row when pressed arrow left on first row     ${row1}    ARROW_LEFT     ${row6}
focus vertical ascending row when pressed arrow up      ${row6}    ARROW_UP       ${row5}
focus last row when pressed arrow up on first row       ${row1}    ARROW_UP       ${row6}
focus vertical descending row when pressed arrow down   ${row1}    ARROW_DOWN     ${row2}
focus first row when pressed arrow down on last row     ${row6}    ARROW_DOWN     ${row1}
