...
navigate between levels
    ...
    Wait Until Element Is Enabled       css:ul[role='listbox']                10s
...
search on first level
    ...
    Element Text Should Be           css:ul[role='listbox']>li          Variant X-335
...
search on 2nd level
    ...
    Element Text Should Be           css:ul[role='listbox']>li             Component HS-921

select action values settings Profile Help
    Go To                            ${STORYBOOK_URL}/iframe.html?id=coreverticalnavigation--verticalnavigation4
    Wait Until Element Is Enabled    (//ul[@role='listbox'])[2]    10s
