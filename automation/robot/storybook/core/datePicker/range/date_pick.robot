...
pick initial on left and end date on right calendar
    ...
    wait until input has value    ${calendarRight} input    9 Aug 2019
...
pick both dates on left calendar
    ...
    Click Element                 ${day}\[8]
    wait until input has value    ${calendarLeft} input    2 Jul 2019
    wait until input has value    ${calendarRight} input    7 Jul 2019
...
pick initial on right and end date on left calendar
    ...
    wait until input has value    ${calendarLeft} input     4 Aug 2019
    wait until input has value    ${calendarRight} input    9 Aug 2019
...
pick dates out current month on left calendar
    ...
    wait until input has value    ${calendarLeft} input    30 Jun 2019
    wait until input has value    ${calendarRight} input    3 Jul 2019
...
pick dates out current month on right calendar
    ...
    wait until input has value    ${calendarRight} input    3 Sep 2019
...
pick same day of month on both calendars
    ...
    wait until input has value    ${calendarRight} input    31 Jul 2019
