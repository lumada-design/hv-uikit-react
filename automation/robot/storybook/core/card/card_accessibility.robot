...
selectable card against WCAG2AA standard          ${pa11yScript}--selectable       ${CURDIR}/WCAG2AA_selectable2.json
no selectable card against WCAG2AA standard       ${pa11yScript}--no-selectable    ${CURDIR}/WCAG2AA_no-selectable2.json
