...
<Meta title="Guides/Styling/Customization" />
...
- [Single instance customization](/docs/guides-styling-customization--inline-styles)
- [Reusable components](/docs/guides-styling-customization--reusable-component)
- [Theme override](/docs/guides-styling-customization--theme-override)
- [Global override](/docs/guides-styling-customization--global-override)
...
through the theme. For more information, please read the [theming](/docs/guides-theming-default-themes--main-ds-5) documentation where a structure of the theme with
...
<Canvas>
  <Story name="GlobalOverride">
    <GlobalOverride />
  </Story>
</Canvas>

Please report to the [theming](/docs/guides-theming-default-themes--main-ds-5) documentation for more information.
