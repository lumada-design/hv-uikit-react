...
- [Default themes](/docs/guides-theming--main-ds-5)
- [Theme structure](/docs/guides-theming--theme-structure)
- [Theme configuration](/docs/guides-theming--create-theme)
- [Theme context](/docs/guides-theming--theme-context)
- [CSS variable](/docs/guides-theming--css-variables)
- [Spacing](/docs/guides-theming--spacing)
...
const MyApp = () => (
  <HvProvider themes={[newTheme]} theme="myTheme" colorMode="sand">
...
const MyApp = () => {
  return (
    <HvProvider themes={[newTheme]} theme="myTheme" colorMode="dawn">
      <MyComponent />
    </HvProvider>
  );
};
