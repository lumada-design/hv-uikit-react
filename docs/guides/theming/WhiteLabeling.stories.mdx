...
The [theming](/docs/guides-theming-default-themes--main-ds-5) documentation offers more detailed information on the default themes' structures and
...
const MyApp = ({ children }) => {
  return (
    <HvProvider themes={[turquoiseTheme]} theme="turquoise" colorMode="dawn">
      {children}
    </HvProvider>
  );
};
...
For more information on how you can customize components, report to the [customization](/docs/guides-theming-customization--inline-styles) documentation.
