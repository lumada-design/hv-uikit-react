...
The simplest way to build a form is by using a native `form`, using the [built-in form validation](https://developer.mozilla.org/en-US/docs/Learn/Forms/Form_validation#using_built-in_form_validation)
...
<Canvas>
  <Story name="Native Form" story={FormSamples.NativeFormStory} />
</Canvas>
