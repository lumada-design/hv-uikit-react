...
import { HvProvider, HvCheckBox } from "@hitachivantara/uikit-react-core";
...
The `HvProvider` enables you to override the default theme and provide your own customizations through the `theme` property. For more information,
please read the [theming](/docs/guides-theming-default-themes--main-ds-5) documentation.
