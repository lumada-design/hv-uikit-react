...
import { HvProvider, HvCheckBox, ds3 } from "@hitachivantara/uikit-react-core";
...
The `HvProvider` enables you to define your themes through the `themes` property. Then, the `theme` and `colorMode` properties are used to specify the active theme
and color mode. For more information, please read the [theming](/docs/guides-theming-default-themes--main-ds-5) documentation.
