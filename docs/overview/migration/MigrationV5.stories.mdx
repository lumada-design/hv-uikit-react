...
In this new version, we also reviewed the **components to be compliant with the most recent guidelines of the latest Design System v5 release**. Furthermore,
...
Furthermore, some components are currently missing from v5.x. Thus, if your application relies on the components listed below, you'll not be able to completely
migrate your application at the moment since their development is still in progress.
...
to manipulate and transform data points. Thus, in v5.x, the visualizations are able to manipulate your data if necessary by splitting, grouping,
and aggregating data points.

For more information about how to use the new visualizations, please take a look at the [visualizations guide](/docs/guides-visualizations--page).
