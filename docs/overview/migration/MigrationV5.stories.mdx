...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- | ------------------------------------------ |
| `theme.hv.palette.accent.*` `theme.hv.palette.atmosphere.*` `theme.hv.palette.base.*` `theme.hv.palette.semantic.*` `theme.hv.palette.support.*` `theme.hv.viz.palette.categorical.*` `theme.hv.viz.palette.sequential.*` `theme.hv.viz.palette.polarized.*` `theme.hv.viz.palette.undefinedState.*` | `theme.colors.*`                        | `activeTheme.colors.modes[selectedMode].*` |
| `theme.hv.spacing.*`                                                                                                                                                                                                                                                                                 | `theme.space.*`                         | `activeTheme.space.*`                      |
| `theme.hv.shadows[*]`                                                                                                                                                                                                                                                                                | `theme.shadows.*`                       | `activeTheme.shadows.*`                    |
...
| `theme.hvSpacing()`                                                                                                                                                                                                                                                                                  | `theme.spacing()`                       | NA                                         |
| `theme.breakpoints.up()`                                                                                                                                                                                                                                                                             | NA                                      | NA                                         |
| `theme.breakpoints.down()`                                                                                                                                                                                                                                                                           | NA                                      | NA                                         |
| `theme.breakpoints.between()`                                                                                                                                                                                                                                                                        | NA                                      | NA                                         |
| `theme.breakpoints.only()`                                                                                                                                                                                                                                                                           | NA                                      | NA                                         |
| `theme.breakpoints.not()`                                                                                                                                                                                                                                                                            | NA                                      | NA                                         |
