...
>
  ...
  >
    ...
    <h2>Components</h2>
    <span>
      Building blocks of the UI that can be used in various combinations to
      create a larger user interface and can be used across different pages or
      applications.
    </span>
  </div>
  <div
  ...
  >
    ...
    <h2>Templates</h2>
    <span>
      Pre-designed layouts or pages that address common UI patterns and can be
      used to quickly create a consistent design for multiple pages or
      applications.
    </span>
  </div>
</div>
