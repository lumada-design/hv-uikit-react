...
# Temporary FIX for being able to access the blackduck server given the issue on the action runners (https://hv-eng.atlassian.net/browse/DEVO-5778)
echo "172.16.10.110 uranus.hitachivantara.com" >> /etc/hosts
cat /etc/hosts
