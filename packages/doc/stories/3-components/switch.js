...
storiesOf("Components/Selection mechanisms", module).add("Toggle Switch", () => <Switch />, {
  title: "Toggle Switch",
  description: "A toggle Switch allows the user to change a setting between two states. ",
