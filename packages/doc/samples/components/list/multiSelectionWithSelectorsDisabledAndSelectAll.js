...
const data = [
  ...
  { label: "Bergamo where you can eat", selected: false, disabled: true },
  { label: "Bergen city", selected: true, disabled: true },
...
export default (
  <div style={{ width: 300 }}>
    <List values={data} multiSelect useSelector {...otherPrps} />
  </div>
);
