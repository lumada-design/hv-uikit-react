...
const SimpleNotificationPanelWithStyles = withStyles(styles, {withTheme: true})(SimpleNotificationPanel)

export default (
	<div style={{width: "100%", height: "100%", display: "flex", justifyContent: "flex-end", position: "relative"}}>
