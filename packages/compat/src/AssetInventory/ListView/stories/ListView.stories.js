...
import { HvListView, HvListViewCell, HvListViewRow } from "../../..";

/* eslint-disable react/prop-types */

export default {
  title: "Compat/Asset Inventory/List View",
  parameters: {
    componentSubtitle: null,
    usage:
      'import { HvListView, HvListViewRow, HvListViewCell } from "@hitachivantara/uikit-react-compat"',
  },
