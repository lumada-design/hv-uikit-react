...
import { HvAssetInventory, HvCardView, HvListView, HvListViewCell, HvListViewRow } from "../..";
import { doSearch, doSort, fetchData, getPages } from "./ServerSideTester";

/* eslint-disable react/prop-types */

export default {
  title: "Compat/Asset Inventory",
  parameters: {
    componentSubtitle: null,
    usage: 'import { HvAssetInventory } from "@hitachivantara/uikit-react-compat"',
    dsVersion: "3.4.0",
  },
