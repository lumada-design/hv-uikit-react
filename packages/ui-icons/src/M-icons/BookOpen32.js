...
export default function BookOpen32(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={48} height={48} viewBox="0 0 48 48" {...props}>
      <g id="BookOpen-32" transform="translate(-649 -1737)">
        ...
        <path id="Path_2437" data-name="Path 2437" d="M-3276.5,757.591l8-2" transform="translate(3953.503 1005.409)" fill="none" stroke="#414141" strokeWidth={2} />
