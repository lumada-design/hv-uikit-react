...
export const ds5Colors = {
  ...
  // semantic
  positive: ["#478B1A", "#649F3C"],
  positive_20: ["#D7E6CF", "#2A651E"],
  positive_80: ["#709C27", "#3C902B"],
  positive_120: ["#227A10", "#8CB050"],
  neutral: ["#4D8AC0", "#5F91BE"],
  neutral_20: ["#D8E6F1", "#395772"],
  warning: ["#F9C846", "#F9D064"],
  warning_20: ["#FBF2D8", "#C2753E"],
  warning_120: ["#F8AC39", "#FAD981"],
  warning_140: ["#F27C27", "#FBE29E"],
  negative: ["#D43136", "#DB4C51"],
  negative_20: ["#F4D3D4", "#832477"],
  negative_80: ["#ED4747", "#C03B56"],
  negative_120: ["#B41B3A", "#F25E5E"],
