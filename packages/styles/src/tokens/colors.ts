...
const light = {
  ...
  infoDimmed: dsColors.neutral_20[0],
  infoSubtle: dsColors.neutral_20[0],
  infoBorder: dsColors.neutral_20[0],
...
const dark = {
  ...
  infoDimmed: dsColors.neutral_20[1],
  infoSubtle: dsColors.neutral_20[1],
  infoBorder: dsColors.neutral_20[1],
