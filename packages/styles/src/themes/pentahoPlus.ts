...
const pentahoPlus = makeTheme((theme) => ({
  ...
  colors: makeColors({
    ...
    containerBackgroundHover: [
      theme.alpha(blue[600], 0.1),
      theme.alpha(blue[500], 0.1),
    ],
    backgroundColor: [slate[100], slate[900]],
    atmo1: [slate[50], slate[800]],
    atmo2: [slate[100], slate[900]],
    atmo3: [slate[200], slate[950]],
    atmo4: [slate[300], slate[700]],
    base_light: slate[50],
    base_dark: slate[700],
    primary_80: [blue[500], blue[400]],
    primary_20: [theme.alpha(blue[600], 0.1), theme.alpha(blue[500], 0.1)],
    secondary: [slate[700], slate[50]],
    secondary_80: [slate[500], slate[200]],
    secondary_60: [slate[400], slate[300]],
    positive_120: [green[700], green[600]],
    positive_80: green[400],
    neutral: sky[500],
    warning_120: [orange[500], amber[600]],
    warning_140: [orange[700], orange[600]],
    negative_120: [red[700], red[600]],
    negative_80: [red[400], red[300]],
