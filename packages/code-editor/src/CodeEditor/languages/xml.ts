...
export type Elements = Record<string, string[] | undefined>; // element name / attributes

/**
 * Gets elements and their attributes from XSD schema.
 */
export const getXsdElementsAndAttributes = (value: string): Elements => {
 ...
 */
export const getXmlCompletionProvider = (
  monaco: Monaco,
  elements?: Elements,
) => {
