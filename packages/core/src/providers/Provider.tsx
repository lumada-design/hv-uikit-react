...
export type HvProviderProps = {
  ...
  /**
   * The UI Kit theme object used to set the theme and inject the customizations needed to meet the specific design needs.
...
/**
 * This component makes cross-component properties associated with the `theme` available down the React tree thanks to React context.
 *
