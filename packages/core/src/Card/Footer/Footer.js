...
const FooterActions = ({
  ...
  const renderActionsGrid = (acts, actWidth) => {
    const actsSlicePart1 = take(acts, maxVisibleActions);
    const actsSlicePart2 = takeRight(acts, acts.length - maxVisibleActions);
    ...
    return (
      ...
      >
        ...
        <DropDown
          ...
          dataList={actsSlicePart2.map(action => ({
            ...action,
