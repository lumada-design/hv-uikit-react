...
describe("ListA11Y", () => {
  it("single selection", async () => {
    ...
    const wrapper = mount(
      <HvProvider>
        <ListWithStyles values={data} selectDefault hasTooltips {...ariaProps} />
      </HvProvider>
    );
  ...
  it("simple list not selectable", async () => {
    ...
    const wrapper = mount(
      <HvProvider>
        <ListWithStyles values={data} selectable={false} {...ariaProps} />
      </HvProvider>
    );
  ...
  it("multi selection with selectors disabled and selectAll", async () => {
    ...
    const wrapper = mount(
      <HvProvider>
        <ListWithStyles values={data} multiSelect useSelector {...ariaProps} />
      </HvProvider>
    );
