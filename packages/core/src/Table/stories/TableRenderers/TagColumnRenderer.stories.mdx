...
import { TagColumnRendererStory } from "./TableRenderers";

<Meta title="Visualizations/Table/Table Renderers/Tag Column Renderer" />
...
<Canvas>
  <Story name="Tag Column Renderer" story={TagColumnRendererStory} />
</Canvas>
