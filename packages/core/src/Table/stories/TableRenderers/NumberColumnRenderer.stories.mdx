...
import { NumberColumnRendererStory } from "./TableRenderers";

<Meta title="Visualizations/Table/Table Renderers/Number Column Renderer" />
...
<Canvas>
  <Story name="Number Column Renderer" story={NumberColumnRendererStory} />
</Canvas>
