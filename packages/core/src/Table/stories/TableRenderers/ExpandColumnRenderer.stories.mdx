...
import { ExpandColumnRendererStory } from "./TableRenderers";

<Meta title="Visualizations/Table/Table Renderers/Expand Column Renderer" />
...
<Canvas>
  <Story name="Expand Column Renderer" story={ExpandColumnRendererStory} />
</Canvas>
