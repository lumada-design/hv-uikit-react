...
import { UseHvTableStickyStory } from "./TableHooks";

<Meta title="Visualizations/Table/Table Hooks/useHvTableSticky" />
...
<Canvas>
  <Story name="useHvTableSticky" story={UseHvTableStickyStory} />
</Canvas>
