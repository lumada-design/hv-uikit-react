...
// #region PROPS
export interface HvUseTableProps extends TableProps, UseHvTableStickyTableProps {}
...
export interface HvUseTableFooterProps extends TableFooterProps, UseHvTableStylesTableCellProps {}
