        ...
        <defs>
          <style
            dangerouslySetInnerHTML={{
              __html: `.cls-1 { fill: none; } .cls-2 { fill: ${theme.colors.acce1}; } .dash { fill: ${theme.colors.acce1}; transition: width .2s ease-in-out; } .selected .dash { width: 19.8px; } .notSelected .dash { width: 0px; }`,
            }}
          />
        </defs>
        <g>
