...
import { UseHvHeaderGroupsStory } from "./TableHooks";

<Meta title="Visualizations/Table/Table Hooks/useHvHeaderGroups" />
...
<Canvas>
  <Story name="useHvHeaderGroups" story={UseHvHeaderGroupsStory} />
</Canvas>
