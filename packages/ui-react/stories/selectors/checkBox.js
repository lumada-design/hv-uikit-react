...
storiesOf("Checkbox", module).add(`Checkbox`, () => (
  <>
    ...
    <HvShowCase
      ...
      description="disabled simple checkbox with no state management"
    >
      <HvCheckBox disabled />
    </HvShowCase>
    ...
    <HvShowCase
      ...
      description="checkbox with label and no state management"
    >
    ...
    <HvShowCase
      ...
      description="disabled checkbox with label and no state management"
    >
    ...
    <HvShowCase
      ...
      description="checkbox with click action and no state management"
    >
      <HvCheckBox
        label="click me!"
        value="A"
    ...
    <HvShowCase
      title="Checkbox wrapped with state management"
      description="Checkbox wrapped in a component enabling state management"
    >
      <WrapperWithState />
    </HvShowCase>
  </>
